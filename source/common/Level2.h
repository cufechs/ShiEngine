...
ShiEngine::GameState* CreateState2(ShiEngine::Application* application){
    ...
    ShiEngine::MeshRenderer* MAutopsy;
    ...
    auto* autopsyGameObj = new ShiEngine::GameObject();
    ...
    meshSuzane->Model( "../assets/models/Ghost2/Ghost.obj");
    ...
    TAutopsy->position = glm::vec3({-120, 7, 55});
    TAutopsy->scale = glm::vec3({0.25,0.25,0.25});
    TAutopsy->rotation = glm::vec3({-45,0,0});
    ...
    transformPlane5->position = glm::vec3({222, 1, 0});
    ...
    transformSuzane->scale = glm::vec3({10,10,10});
    ...
    transformCubeObj->position = glm::vec3({220, 12, 0});
    ...
    transformPointLightS1->position = glm::vec3({130, 15, 0});
    ...
    transformPointLightS2->position = glm::vec3({130, 15, 4});
    ...
    transformPointLightS3->position = glm::vec3({80, 15, -20});
    ...
    transformPointLightS4->position = glm::vec3({80, 15, -16});
    ...
    transformPointLightS5->position = glm::vec3({10, 13, 30});
    ...
    transformPointLightS6->position = glm::vec3({10, 13, 34});
    ...
    transformPointLightS7->position = glm::vec3({-90, 15, 10});
    ...
    transformPointLightS8->position = glm::vec3({-90, 15, 14});
    ...
    transformPointLightS9->position = glm::vec3({-120, 15, -20});
    ...
    transformPointLightS10->position = glm::vec3({-120, 15, -16});
    ...
    transformPointLight5->position = glm::vec3({-154, 13, -2});
    ...
    transformPointLight6->position = glm::vec3({-154, 13, 2});
    ...
    moveEnemy1 = new ShiEngine::EnemyMovement(7.0f);
    //moveEnemy1->setOscillateZ(25.0, 0.1);
    //moveEnemy1->setOscillateX(5.0, 0.4);
    moveEnemy1->setFollow(transformCamera, true, true);

    moveEnemy2 = new ShiEngine::EnemyMovement(7.0f);
    //moveEnemy2->setOscillateY(2.0, 0.1);
    //moveEnemy2->setOscillateZ(25.0, 0.1);
    //moveEnemy2->setOscillateX(5.0, 0.4);
    moveEnemy2->setFollow(transformCamera, true, true);

    moveEnemy3 = new ShiEngine::EnemyMovement(1);
    //moveEnemy3->setOscillateY(2.0, 0.1);
    moveEnemy3->setOscillateZ(50.0, 0.1);
    moveEnemy3->setOscillateX(20.0, 0.4);
    //moveEnemy3->setFollow(transformCamera, true, true);

    moveEnemy4 = new ShiEngine::EnemyMovement(1);
    moveEnemy4->setOscillateZ(50.0, 0.1);
    moveEnemy4->setOscillateX(20.0, 0.4);
    //moveEnemy4->setFollow(transformCamera, true, true);

    moveEnemy5 = new ShiEngine::EnemyMovement(1);
    moveEnemy5->setOscillateY(2.0, 0.1);
    moveEnemy5->setOscillateZ(40.0, 2.4);
    //moveEnemy5->setFollow(transformCamera, true, true);

    moveEnemy6 = new ShiEngine::EnemyMovement(1);
    moveEnemy6->setOscillateY(2.0, 0.1);
    moveEnemy6->setOscillateZ(40.0, 2.4);
    //moveEnemy6->setFollow(transformCamera, true, true);

    moveEnemy7 = new ShiEngine::EnemyMovement(1);
    moveEnemy7->setOscillateY(2.0, 0.1);
    moveEnemy7->setOscillateZ(50.0, 1.6);
    //moveEnemy7->setFollow(transformCamera, true, true);

    moveEnemy8 = new ShiEngine::EnemyMovement(1);
    moveEnemy8->setOscillateY(2.0, 0.1);
    moveEnemy8->setOscillateZ(50.0, 1.6);
    //moveEnemy8->setFollow(transformCamera, true, true);

    moveEnemy9 = new ShiEngine::EnemyMovement(1);
    moveEnemy9->setOscillateY(2.0, 0.1);
    moveEnemy9->setOscillateZ(20.0, 0.8);

    moveEnemy10 = new ShiEngine::EnemyMovement(1);
    moveEnemy10->setOscillateY(2.0, 0.1);
    moveEnemy10->setOscillateZ(20.0, 0.8);

    moveEnemy11 = new ShiEngine::EnemyMovement(1);
    moveEnemy11->setOscillateY(2.0, 0.1);
    moveEnemy11->setOscillateZ(55.0, 2.5);

    moveEnemy12 = new ShiEngine::EnemyMovement(1);
    moveEnemy12->setOscillateY(2.0, 0.1);
    moveEnemy12->setOscillateZ(55.0, 2.5);
    ...
    directionalLight->setAttenuation(0,0,0.1);
    directionalLight->setPhong(glm::vec3({0.5,0.5,0.5}), glm::vec3({1,1,1}), glm::vec3({0.1,0.1,0.1}));
    ...
    MAutopsy->SetRenderState(renderState1);
    ...
    MATAutposy->albedo_tint = {1, 1, 1}; // The reflectance color
    MATAutposy->specular_tint = {1, 1, 1};
    MATAutposy->roughness_range = {0,1};
    MATAutposy->emissive_tint = {1,1,1};
    MATAutposy->setTexture(textureAutpsy);
    MATAutposy->setSampler(sampler1);
    ...
    MAutopsy->SetMaterial(MATAutposy);
...
//////-------//////
    ...
    autopsyGameObj->AddComponent(TAutopsy);
    autopsyGameObj->AddComponent(MAutopsy);
    autopsyGameObj->Name = "extinguisher";
    ...
    state->addGameObject(autopsyGameObj);
