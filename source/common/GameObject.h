...
public:
	...
	GameObject Parent = null; //Not yet implemented
	list<GameObjectComponent> GameObjectComponents; //List of all  GO componets in a certain scene(scene is not yet implemented)
	string Tag;
	int GameComponentsCount = 0;
	bool Active
	{
		set
		{
